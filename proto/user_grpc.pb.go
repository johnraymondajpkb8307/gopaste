...
const (
	UserService_Register_FullMethodName = "/paste.UserService/Register"
	UserService_Login_FullMethodName    = "/paste.UserService/Login"
	UserService_Logout_FullMethodName   = "/paste.UserService/Logout"
)
